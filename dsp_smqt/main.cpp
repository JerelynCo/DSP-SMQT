...
void Image::writeToFile() {
    ...
    bSuccess = imwrite("/home/jerelynco/ClionProjects/dsp_smqt/toptal_written.png", mmImg, vCompression_params);
    if (!bSuccess){
...
int main() {
    ...
    Image origImage("/home/jerelynco/ClionProjects/dsp/toptal.png");
